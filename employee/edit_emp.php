                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-md-12">
                                          <select class="form-control team"   name="department_id[]" multiple="" required="">
                                              <?php
                                               $department_id_array = explode(',', $data['department_id']);
                                              $sql_department = "SELECT * FROM departments";
                                              $department_query = mysqli_query($connection, $sql_department);
                                              while ($department = mysqli_fetch_array($department_query)) {
                                                  ?>
                                                  <option value="<?php echo $department['id']; ?>" <?php if(in_array($department['id'],$department_id_array)){echo "selected";} ?>><?php echo $department['department_name']; ?></option>
                                              <?php } ?>
                                          </select>
                                      </div>
                                  </div><!--END-->
                                  <div class="form-group row">
                                      ...
                                      <div class="col-md-12">
                                          <select class="form-control" name="designation_id"   required="">
                                              ...
                                              $sql_designation = "SELECT designations.id as id, designations.designation_name as designation_name FROM `designations`"; 
